...
class ViewController: UIViewController {
	...
	let image = UIImage(named: "saltShaker v2")
	
	let particlesImage = UIImage(named: "Particles")
	let particlesImage2 = UIImage(named: "ParticlesFlipped")
	...
	let shakeSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("salt_shake4", ofType: "wav")!)
